...
(function () {
  ...
  // Season sponsor badge, pinned to the header's top-right corner on every
  // screen size (a pre-built "Sponsored by <logo>" image, rather than a
  // separate text label + logo, so it never has to wrap or fight the nav for
  // room on a small phone screen). To swap or remove the sponsor in future,
  // this is the only place that needs to change.
  var SPONSOR = { name: 'Trebles', logo: 'assets/sponsor-badge.png' };
